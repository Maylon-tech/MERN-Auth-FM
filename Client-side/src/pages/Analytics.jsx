...
import { HiOutlineChartBar, HiOutlineLogout, HiOutlineUserCircle, HiOutlineViewGrid } from "react-icons/hi"
        ...
        <main className="flex-1 p-8 overflow-y-auto">
            <header className="flex justify-between items-center mb-10">
                <div>
                    <h1 className="text-3xl font-light tracking-tight">
                        Welcome Back, <span>{user?.username || "Commander"}</span>
                    </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-[#181818] border border-[#292929] p-6 rounded-2xl hover:border-[#ffe6005a] transition-all">
                    ...
                    <h3 className="text-zinc-400 text-xs font-bold tracking-widest uppercase">Frontend Core</h3>
                ...
                <div className="bg-[#181818] border border-[#292929] p-6 rounded-2xl hover:border-[#ffe6005a] transition-all">
                    ...
                    <h3 className="text-zinc-400 text-xs font-bold tracking-widest uppercase">Styling Engine</h3>
                ...
                <div className="bg-[#181818] border border-[#292929] p-6 rounded-2xl hover:border-[#ffe6005a] transition-all">
                    ...
                    <h3 className="text-zinc-400 text-xs font-bold tracking-widest uppercase">Motion System</h3>
                    <p className="text-2xl font-bold mt-2">GSAP & Framer</p>            
                </div>
            </div>
    
            <section className="mt-8 bg-linear-to-r from-[#181818] to-[#0a0a0a] border border-[#292929] rounded-3xl p-10 relative overflow-hidden h-64 flex items-center">
            <div className="relative z-10">
                <h2 className="text-4xl extralight tracking-widest">COSMO OS</h2>
                <p className="text-zinc-400 mt-2 max-w-md">
                Your interface for building high-end, animated frontend experience.
                </p>
            </div>
